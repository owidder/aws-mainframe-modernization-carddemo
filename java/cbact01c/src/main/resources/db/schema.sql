-- Replaces VSAM ACCTDAT file (ACCTFILE-FILE in CBACT01C)
-- Record layout follows copybook app/cpy/CVACT01Y.cpy (ACCOUNT-RECORD, 300 bytes)
-- Keyed on ACCT-ID PIC 9(11) — matches SELECT ACCTFILE-FILE ... RECORD KEY IS FD-ACCT-ID
...
CREATE TABLE IF NOT EXISTS accounts (
    ...
    curr_cyc_debit       DECIMAL(12,2) NOT NULL DEFAULT 0,     -- ACCT-CURR-CYC-DEBIT    PIC S9(10)V99 COMP-3
